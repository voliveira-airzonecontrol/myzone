...
def train_model(
    ...
    for i, combination in enumerate(tqdm(param_combinations, desc="Hyperparameter Grid Search")):
        ...
        y_pred_proba = model.predict_proba(X_test)[:, 1]  # Probabilistic predictions for ROC AUC
